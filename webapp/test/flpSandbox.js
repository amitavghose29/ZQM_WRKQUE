		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Working Queue",
									"targetURL": "#comairbuszqmwrkque-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comairbuszqmwrkque-display": {
								"semanticObject": "comairbuszqmwrkque",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.airbus.zqmwrkque",
									"url": sap.ui.require.toUrl("com/airbus/zqmwrkque")
								}
							}
						}
					}
